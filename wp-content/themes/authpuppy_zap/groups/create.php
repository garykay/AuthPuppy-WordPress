				...
				<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
					...
					<div class="radio">
						<label><input type="radio" name="group-status" value="public"<?php if ( 'public' == bp_get_new_group_status() || !bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> />
							...
							<p>
								<?php _e( 'Any site member can join this group.', 'buddypress' ) ?><br />
								<?php _e( 'This group will be listed in the groups directory and in search results.', 'buddypress' ) ?><br />
						...
						<label><input type="radio" name="group-status" value="private"<?php if ( 'private' == bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> />
							...
							<p>
								<?php _e( 'Only users who request membership and are accepted can join the group.', 'buddypress' ) ?><br />
								<?php _e( 'This group will be listed in the groups directory and in search results.', 'buddypress' ) ?><br />
						...
						<label><input type="radio" name="group-status" value="hidden"<?php if ( 'hidden' == bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> />
							...
							<p>
								<?php _e( 'Only users who are invited can join the group.', 'buddypress' ) ?><br />
								<?php _e( 'This group will not be listed in the groups directory or search results.', 'buddypress' ) ?><br />
								<?php _e( 'Group content and activity will only be visible to members of the group.', 'buddypress' ) ?>
							</p>
						</label>
					</div>
